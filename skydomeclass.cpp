...
bool SkyDomeClass::Initialize(ID3D11Device* device)
{
	...
	m_apexColor = XMFLOAT4(0.0f, 0.7f, 1.0f, 1.0f);
	m_apexColor = XMFLOAT4(0.0f, 0.4f, 0.9f, 1.0f);

	// Set the color at the center of the sky dome.
	m_centerColor = XMFLOAT4(0.4f, 0.6f, 0.8f, 1.0f);
	m_centerColor = XMFLOAT4(0.02f, 0.7f, 1.0f, 1.0f);
